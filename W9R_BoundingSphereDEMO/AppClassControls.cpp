...
void AppClass::ProcessKeyboard(void)
{
	...
	static bool bNum1Previous, bNum2Previous, bNum3Previous;

#pragma region ON_KEY_PRESS_RELEASE
	static bool	bLastF1 = false, bLastF2 = false, bLastF3 = false, bLastF4 = false, bLastF5 = false,
				bLastF6 = false, bLastF7 = false, bLastF8 = false, bLastF9 = false, bLastF10 = false,
				bLastEscape = false, bLastF = false, blastNum1 = false, blastNum2 = false, blastNum3 = false;
...
#pragma region Camera Positioning
	...
	if (sf::Keyboard::isKeyPressed(sf::Keyboard::Left))
	{
		...
		if (m_pBOMngr->objectList[0].m_bColliding) {
			m_v3Position += vector3(-0.002f, 0.0f, 0.0f);
		}
		else {
			m_v3Position += vector3(-0.1f, 0.0f, 0.0f);
		}
		m_pBOMngr->objectList[0].SetModelMatrix(glm::translate(m_v3Position));
	}
	...
	if (sf::Keyboard::isKeyPressed(sf::Keyboard::Up))
	{
		...
		{
			if (m_pBOMngr->objectList[0].m_bColliding) {
				m_v3Position += vector3(0.0f, 0.002f, 0.0f);
			}
			else {
		...
		{
			if (m_pBOMngr->objectList[0].m_bColliding) {
				m_v3Position += vector3(0.0f, 0.0f, -0.002f);
			}
			else {
	...
	if (sf::Keyboard::isKeyPressed(sf::Keyboard::Down))
	{
		if (!bModifier)
		{
			if (m_pBOMngr->objectList[0].m_bColliding) {
				...
				m_v3Position += vector3(0.0f, -0.1, 0.0f);
			}
			m_pBOMngr->objectList[0].SetModelMatrix(glm::translate(m_v3Position));
		}
		else
	...
	if (sf::Keyboard::isKeyPressed(sf::Keyboard::Num1)) {
		if (!bNum1Previous) {
			bNum1Previous = true;
			m_pBOMngr->objectList[0].m_iBoundingObjectType++;
		}
	}
	else {
		bNum1Previous = false;
	...
	if (sf::Keyboard::isKeyPressed(sf::Keyboard::Num2)) {
		if (!bNum2Previous) {
			bNum2Previous = true;
			m_pBOMngr->objectList[1].m_iBoundingObjectType++;
		}
	}
	else {
		bNum2Previous = false;
	...
	if (sf::Keyboard::isKeyPressed(sf::Keyboard::Num3)) {
		if (!bNum3Previous) {
			bNum3Previous = true;
			m_pBOMngr->objectList[2].m_iBoundingObjectType++;
		}
	}
	else {
		bNum3Previous = false;
